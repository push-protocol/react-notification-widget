...
export const Subscribe = () => {
  ...
  const [subscribeUser, { loading: subscribeLoading }] =
    useUserSubscribeMutation({
      variables: {
        input: {
          source: discordToken ? UserSubscribeSource.Discord : undefined,
        },
      },
    });
  ...
  const handleSubscribe = async () => {
    ...
    setLoadingMsg(
      "Sign the message in your wallet to verify ownership of your account"
    );
    await login();
    ...
    setRoute(
      messageCategories.length ? Routes.SelectCategories : Routes.SetupApps
    );
  };
