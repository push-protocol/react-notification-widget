...
export const SetupApps = (props: { appsToConnect: MessagingApp[] }) => {
  ...
  const { userCommsChannels, setUserCommsChannelsPollInterval } =
    useUserContext();
  ...
  return (
    <Screen mb={1}>
      <Header>
        ...
        <Notice
          mt={0.5}
          text={`Wherever will forward messages sent to you wallet`}
        />
      </Header>
      ...
      <Notice
        mb={1}
        text={`Wherever will never share your info with ${name} or anyone else.`}
      />
    </Screen>
  );
};
